...
#define FILTER_FRIENDLY_NAME        L"Functional Test Lightweight Filter"
#define FILTER_UNIQUE_NAME          L"{4b399bac-cfdf-477b-9c72-abed8717bc1a}"
#define FILTER_SERVICE_NAME         L"fnlwf"
...
{
    FnIncrementReferenceCount(&Filter->ReferenceCount);
}
    ...
    )
{
    ...
    FnInitializeReferenceCount(&Filter->ReferenceCount);
